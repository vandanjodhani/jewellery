                ...
                <div className="container">
                    <div className="privacy-inner">
                        <div className="privacy">
                            <h3>Who we are</h3>
                            <p>Our website address is: http://demo.roadthemes.com/corano.</p>
                        </div>
                        <div className="privacy">
                            <h3>What personal data we collect and why we collect it</h3>
                            <div className="sub-privacy">
                                <h4>Comments</h4>
                                <p>When visitors leave comments on the site we collect the data shown in the comments form, and also the visitor’s IP
                                    address and browser user agent string to help spam detection.</p>
                                <p>An anonymized string created from your email address (also called a hash) may be provided to the Gravatar service to
                                    see if you are using it. The Gravatar service privacy policy is available here: https://automattic.com/privacy/.
                            ...
                            <div className="sub-privacy">
                                <h4>Cookies</h4>
                                <p>If you leave a comment on our site you may opt-in to saving your name, email address and website in cookies. These are
                                ...
                                <p>If you have an account and you log in to this site, we will set a temporary cookie to determine if your browser accepts
                        ...
                        <div className="privacy">
                            ...
                            <p>If you leave a comment, the comment and its metadata are retained indefinitely. This is so we can recognize and approve any
                        ...
                        <div className="privacy">
                            ...
                            <p>If you have an account on this site, or have left comments, you can request to receive an exported file of the personal
                                ...
                                we hold about you. This does not include any data we are obliged to keep for administrative, legal, or security purposes.</p>
                        </div>
                        <div className="privacy">
