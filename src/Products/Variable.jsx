...
const Variable = () => {
  ...
  const thumbnails = [
    {
      url: "http://wp.plazathemes.com/corano/wp-content/uploads/2018/11/19.jpg",
    ...
    {
      url: "http://wp.plazathemes.com/corano/wp-content/uploads/2018/11/10.jpg",
      alt: "Pear-Shaped Black Ring Back View",
    },
    {
      url: "http://wp.plazathemes.com/corano/wp-content/uploads/2018/11/11.jpg",
          ...
          <div className="container">
            <div className="grouped-product-inner">
              ...
              <div className="product-details">
                ...
                <h1 className="product-title">ZMens Womens 10k</h1>
                ...
                <div className="price-range">$7.00 - $9.00</div>
                ...
                <div className="product-options">
                  <div className="color-opt">
                    <h4>COLOR</h4>
                    <select name="color">
                      <option value="">Choos an option</option>
