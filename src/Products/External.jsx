...
const External = () => {
  ...
  const thumbnails = [
    ...
    {
      url: "http://wp.plazathemes.com/corano/wp-content/uploads/2018/11/5.jpg",
          ...
          <div className="container">
            <div className="grouped-inner">
              ...
              <div className="grouped-path">
                ...
                <a href="#">Runners</a>
                <span>&gt;</span>
                <a href="#">Dissent Collar Earring </a>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="container">
            <div className="grouped-product-inner">
              ...
              <div className="product-details">
                ...
                <h1 className="product-title">Dissent Collar Earring</h1>
                ...
                <div className="price-range">$95.00</div>
                ...
                <div className="product-meta">
                  <div className="categories">
                    Categories: <a href="#">Necklaces</a>,{" "}
                    <a href="#">Runners</a>
                  </div>
                  <div className="tags">
                    Tags: <a href="#">laptop</a>
                  </div>
                </div>
